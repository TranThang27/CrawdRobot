...
arm_pose = {
    ...
    'arm_right_1_joint': 1.5        ,   # Xoay vai phải vào trong một chút
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    while viewer.is_running():
        ...
        for _ in range(speed_factor):
            ...
            apply_constant_move(model, data, speed=25.0)
            ...
            for act_id in arm_actuator_ids:
                ...
                # Nếu bạn muốn giữ góc cố định (cho position control):
                # data.ctrl[act_id] = arm_pose.get(act_name.replace("_position", ""), 0.0)
                
                # Nếu là velocity control (như file cũ của bạn), ta gán 0.0 để khóa khớp
